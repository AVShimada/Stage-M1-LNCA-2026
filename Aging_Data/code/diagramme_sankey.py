...
df = pd.read_csv('C:/Users/aure6/Downloads/Stage_M1_Github/Stage-M1-LNCA-2026/Aging_Data/code/sankey_data_FC_MEANS.csv')
...
fig.update_layout(title_text="Évolution de l'allégeance des nœuds FC (G1 -> G2 -> G3)", font_size=12)
fig.show()

# 1. Charger les données
df = pd.read_csv('C:/Users/aure6/Downloads/Stage_M1_Github/Stage-M1-LNCA-2026/Aging_Data/code/sankey_data_SC_MEANS.csv')
...
fig.update_layout(title_text="Évolution de l'allégeance des nœuds SC (G1 -> G2 -> G3)", font_size=12)
fig.show()